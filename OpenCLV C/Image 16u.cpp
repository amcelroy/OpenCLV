...
void WriteImage_u16(clLabviewDevice *d, cl_mem ImageObject, size_t Width, size_t Height, size_t Depth,
	...
	*Error = clLabviewDevice::Error(clLabviewDevice::SanitizeDevice(d));
	...
	try{
		...
		unsigned short test = Data[Width*Height*Depth];
...
void ReadImage_u16(clLabviewDevice *d, cl_mem ImageObject, size_t Width, size_t Height, size_t Depth,
				size_t XOffset, size_t YOffset, size_t ZOffset, unsigned short *Data, double *Time, int *Error){
