...
void WriteImage_i16(clLabviewDevice *d, cl_mem ImageObject, size_t Width, size_t Height, size_t Depth,
	...
	*Error = clLabviewDevice::Error(clLabviewDevice::SanitizeDevice(d));
	...
	try{
		...
		short test = Data[Width*Height*Depth];
...
void ReadImage_i16(clLabviewDevice *d, cl_mem ImageObject, size_t Width, size_t Height, size_t Depth,
				size_t XOffset, size_t YOffset, size_t ZOffset, short *Data, double *Time, int *Error){
